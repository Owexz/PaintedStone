...
public class PaintedStone extends JavaPlugin
{
    ...
    public void onEnable()
    {
        ...
        SpoutManager.getMaterialManager().registerSpoutRecipe(recipe9);
        SpoutShapedRecipe recipe24 = new SpoutShapedRecipe(new SpoutItemStack(PurpleStoneBlock, 4));
        ...
        SpoutShapedRecipe recipe25 = new SpoutShapedRecipe(new SpoutItemStack(RedStoneBlock, 4));
        ...
        SpoutShapedRecipe recipe26 = new SpoutShapedRecipe(new SpoutItemStack(WhiteStoneBlock, 4));
        ...
        SpoutShapedRecipe recipe27 = new SpoutShapedRecipe(new SpoutItemStack(YellowStoneBlock, 4));
